...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_3[74] = {
0x34,0x04,0x00,0x00,0x01,0x06,0x01,0x2d,0x05,0x00,0x01,0x01,0x03,0x05,0x12,0x05,0x62,0x05,0x5e,0x05,
0x00,0x01,0x04,0x05,0x01,0x05,0x03,0x2f,0x05,0x01,0x00,0x01,0x06,0x04,0x2f,0x05,0x02,0x01,0x27,0x05,
0x00,0x1e,0x1d,0x06,0x03,0x51,0x07,0x00,0x01,0x08,0x01,0x52,0x07,0x51,0x08,0x01,0x52,0x07,0x01,0x08,
0x04,0x52,0x07,0x51,0x08,0x02,0x52,0x07,0x2d,0x05,0x04,0x02,0x38,0x03,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_3, 4, (MRB_SYM(name), 0,MRB_SYM(m), MRB_SYM(sc), ), const);
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_1[10] = {
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_10[32] = {
0x34,0x00,0x10,0x03,0x21,0x04,0x02,0x00,0x11,0x05,0x01,0x06,0x01,0x49,0x05,0x53,0x06,0x00,0x01,0x07,
0x02,0x55,0x06,0x01,0x07,0x03,0x30,0x04,0x00,0xff,0x38,0x04,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_10, 3, (MRB_SYM(args), MRB_SYM(opts), MRB_SYM(b), ), const);
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_7[15] = {
0x34,0x00,0x00,0x00,0x12,0x02,0x57,0x04,0x00,0x2e,0x03,0x00,0x00,0x38,0x03,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_7, 2, (0,MRB_SYM(m), ), const);
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_14[36] = {
0x34,0x00,0x10,0x03,0x21,0x05,0x01,0x00,0x11,0x06,0x01,0x07,0x01,0x49,0x06,0x53,0x07,0x00,0x01,0x08,
0x02,0x55,0x07,0x01,0x08,0x03,0x30,0x05,0x00,0xff,0x2d,0x04,0x00,0x01,0x38,0x04,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_14, 3, (MRB_SYM(args), MRB_SYM(opts), MRB_SYM(block), ), const);
...
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_8, 2, (MRB_SYM(other), 0,), const);
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_18[36] = {
0x34,0x00,0x10,0x03,0x21,0x04,0x01,0x00,0x11,0x06,0x01,0x07,0x01,0x49,0x06,0x53,0x07,0x00,0x01,0x08,
0x02,0x55,0x07,0x01,0x08,0x03,0x2e,0x05,0x00,0xff,0x2f,0x04,0x00,0x01,0x38,0x04,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_18, 3, (MRB_SYM(args), MRB_SYM(opts), MRB_SYM(block), ), const);
...
0x34,0x04,0x00,0x00,0x56,0x03,0x00,0x38,0x03,};
mrb_DEFINE_SYMS_VAR(gem_mrblib_mruby_method_proc_lv_9, 2, (MRB_SYM(other), 0,), const);
...
static const mrb_code gem_mrblib_mruby_method_proc_iseq_2[26] = {
...
NULL,NULL,MRB_TT_PROC,MRB_GC_RED,0,{&gem_mrblib_mruby_method_proc_irep_0},NULL,{NULL},
}};
static void
